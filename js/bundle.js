...
"use strict";
eval("\n\nvar _alert = __webpack_require__(/*! ./alert */ \"./js/alert.js\");\n\n$(document).on('submit', '#contact-form', function (e) {\n  e.preventDefault();\n  $('.contact-submit').text('Submitting...');\n  var name = $('#contact-name').val();\n  var email = $('#contact-email').val();\n  var phone = $('#contact-phone').val();\n  var subject = $('#contact-subject').val();\n  var message = $('#contact-message').val();\n  var data = {\n    name: name,\n    email: email,\n    phone: phone,\n    subject: subject,\n    message: message\n  };\n  axios.post('https://brainfuze-23330-default-rtdb.firebaseio.com/students.json', data).then(function (response) {\n    (0, _alert.showAlert)('success', 'We got you, we will reach out to you. as soon as possible', 5);\n    $('.contact-submit').text('Submit');\n    $('#contact-name').val('');\n    $('#contact-email').val('');\n    $('#contact-phone').val('');\n    $('#contact-subject').val('');\n    $('#contact-message').val('');\n  }).catch(function (err) {\n    (0, _alert.showAlert)('error', 'Something gone wrong, try again!', 5);\n  });\n});\n\n//# sourceURL=webpack:///./js/contact.js?");
